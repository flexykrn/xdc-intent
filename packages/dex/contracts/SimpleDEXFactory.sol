...
contract SimpleDEXFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        // Create pair using minimal proxy
...
contract SimpleDEXPair {
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        ...
        if (timeElapsed > 0 && _reserve0 != 0 && _reserve1 != 0) {
            // Simplified price tracking (skip UQ112x112 for now)
            price0CumulativeLast += (uint(_reserve1) * timeElapsed) / _reserve0;
            price1CumulativeLast += (uint(_reserve0) * timeElapsed) / _reserve1;
        }
